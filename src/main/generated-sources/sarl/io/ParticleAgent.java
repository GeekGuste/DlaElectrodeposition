...
public class ParticleAgent extends Agent {
  ...
  @SyntheticMember
  public ParticleAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public ParticleAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public ParticleAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
